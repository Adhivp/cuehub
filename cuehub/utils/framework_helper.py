...
def read_project_files(project_dir):
    """
    Read all the content of project files in the specified directory.
        ...
        for file in files:
            ...
            try:
                with open(file_path, 'r', encoding='utf-8') as f:
                    content = f.read()
                project_contents[file_path] = content
            except Exception as e:
                project_contents[file_path] = f"Error reading file: {str(e)}"
